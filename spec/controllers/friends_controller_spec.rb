describe FriendsController, type: :controller do
  ...
  describe 'PATCH #update' do
    ...
    subject(:update_request) { patch :update, params: { id: friend.id, friend: new_attributes}}
    it 'returns http redirect' do
      update_request
      expect(response).to have_http_status(302)
    end
  ...
  describe 'DELETE #destroy' do
    ...
    it 'redirects to friend index' do
      destroy_request
  ...
  describe 'GET #school' do
    ...
    it 'render the school template' do
      school_request
  ...
  describe 'GET #holiday' do
    ...
    it 'render the holiday template' do
      holiday_request
  ...
  describe 'GET #work' do
    ...
    it 'render the work template' do
      work_request
